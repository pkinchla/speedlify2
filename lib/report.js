...
export async function buildReport({
	...
	const groups = Object.entries(config.groups).map(([id, group]) => {
		...
		return {
			...
			// Off the home page's list of categories, but nowhere else: it still
			// has its page, still appears in the switcher, and its sites still rank
			// everywhere they would have.
			hideFromCategoryList: group.hideFromCategoryList === true,
